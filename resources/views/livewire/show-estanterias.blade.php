<div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="px-6  py-6 flex items-center">
            ...
            <div class="min-w-min">
                @livewire('create-estanteria')
            </div>

        </div>
        @if ($estanterias->count())
            <x-table>
                        ...
                        @foreach ($estanterias as $estanteria)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ $estanteria->ciudad->nombre }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900"> {{ $estanteria->nombre }}</div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                 ...
                                 <td class="px-6 py-4 whitespace-nowrap ext-sm font-medium flex">
                                   <a class="btn btn-green" wire:click="edit({{ $estanteria }})">
                                        <i class="fas fa-edit">
                                        </i>
                                    </a>

                                 
                                    <a class="btn btn-red ml-2" wire:click="$emit('borrarCiudad',{{ $estanteria->id }})">
